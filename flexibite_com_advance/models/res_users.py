...
class ResUsers(models.Model):
    ...
    pos_security_pin = fields.Char(string='Security PIN', related='employee_id.pin', help='A Security PIN used to protect sensible functionality in the Point of Sale')
