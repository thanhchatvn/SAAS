...
class AccountAgedReceivable(models.TransientModel):
    ...
    def generate_aged_receivable(self):
        ...
        return self.env.ref('flexibite_com_advance.report_aged_receivable').report_action(self, data=datas)

    
    def generate_account_receivable_xls(self):
        report_obj = self.env['report.flexibite_com_advance.aged_receivable_template']
        styleP = xlwt.XFStyle()
