    ...
    function start_lock_timer(time_interval,self){
        ...
        idleActions = [{
            ...
            action: function () {
                ...
                rpc.query(params, {async: false}).guardedCatch(function(){
...
//		},
        renderElement: function() {
            ...
            // console.log(self.pos.chrome.screens.products);
...
//            			self.pos.chrome.screens.products.render_product_category([categ]);
            ...
            if(!self.pos.load_background){
                ...
                // alert(self.pos + "lllllllkkkkkkkkkkkkkkkkkkkkkk");
                $.ajax({
                    type: "POST",
                ...
                // console.log(self);
                // alert(self.pos.product_domain);
                
                var domainss = typeof self.pos.product_domain === 'function'  ? self.pos.product_domain(self.pos)  : self.pos.product_domain; 
                // alert(domainss);
                var data = {
                    'config_id': self.pos.config.id,
                    'product_domain': domainss,
    ...
    screens.PaymentScreenWidget.include({
        ...
        unpaid_draft_order: function(){
            ...
            if(order){
                ...
                var receipt_html = QWeb.render('OrderReceipt',env);
        ...
        add_charge_product: function(){
            ...
            if(paylines){
                paylines.map(function(payline){
                    alert(payline.cashregister);
                    console.log(payline.cashregister);
...
//        	this._super(id);
            ...
            var cashregister = _.find(self.pos.payment_methods, function(cashregister){
                return cashregister.id === id;
            });

            if(cashregister && cashregister.is_online_journal){
        ...
        renderElement: function(){
            // alert("rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr");
            // alert(this.pos.payment_methods);
            // console.log(this.pos.payment_methods);
            this._super();
            var self =  this;
            // alert(self.pos.payment_methods);
            // console.log(self.pos.payment_methods);
            var order = self.pos.get_order();
            ...
            this.$('div.1quickpay').click(function(){
                ...
                if(amt){
                    ...
                    for(var i in self.pos.payment_methods){
                        var reg = self.pos.payment_methods[i];
...
//    		});
    ...
    screens.ProductScreenWidget.include({
        ...
        start: function(){
            // alert(";;;;llllllllllllllllllllllllll")
            var self = this;
            self._super();
            ...
            self.custom_switch_category_handler = function(event){
                ...
                // console.log(self.pos.chrome.screens.products.product_categories_widget);
                var products = self.pos.chrome.screens.products;
                var sub_categories = products.product_categories_widget.subcategories;
                if(id == 0){
                    self.parent_categ_id = false;
...
//                });
        ...
        partner_icon_url: function(id){
            return '/web/image?model=res.partner&id='+id+'&field=image_1920';
        },
    });
...
//        	return window.location.origin + '/web/image?model=product.product&field=image_1920&id='+product.id;
//        },
//
//        renderElement: function() {
//            var self = this;
...
//	        };
        ...
        filter_variant: function(){
            ...
            for (var index in this.variant_list){
                ...
                var found = true;
                for (var i = 0; i < value_list.length; i++){
                    found = found && (variant.product_template_attribute_value_ids.indexOf(value_list[i]) != -1);
                }
                if (found){
                    this.filter_variant_list.push(variant);
                }
