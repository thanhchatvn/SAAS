	...
	function start_lock_timer(time_interval,self){
        ...
        idleActions = [{
            ...
            action: function () {
    	    	...
    	    	// alert("...............ggggggggg");
    	    	rpc.query(params, {async: false}).then(function(result){}).guardedCatch(function(){
...
//		},
		...
		delete_msg_history: function(){
	    	...
	    	// alert("jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj");
	    	rpc.query(params, {async: false}).then(function(result){
	    		if(result){
	    ...
	    user_icon_url(id){
			return '/web/image?model=res.users&id='+id+'&field=image_128';
		},
	});
...
//        	},
        	...
        	self.x_report = function(){
        		...
        		// alert("jjfffffffffffffffffffffff");
