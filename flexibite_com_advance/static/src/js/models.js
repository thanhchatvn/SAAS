odoo.define('flexibite_com_advance.models', function (require) {
    ...
    models.load_fields("res.users", ['image_128','login','company_ids','access_ereceipt','access_quick_cash_payment',
                                     ...
                                     'user_role','pos_security_pin','pos_category_ids','access_out_of_stock_details','access_int_trans','shop_ids',
    ...
    models.load_fields("product.product", ['qty_available','type','is_packaging','loyalty_point',
                                           ...
                                           'priority','product_template_attribute_value_ids', 'lst_price','write_date']);
    ...
    models.load_fields("pos.payment.method", ['shortcut_key','jr_use_for','apply_charges','fees_amount','fees_type','optional','is_online_journal']);
...
//        },
        ...
        load_new_partners: function(){
            ...
            var domain = [['customer_rank','>',0],['write_date','>',this.db.get_partner_write_date()]];
            rpc.query({
                    model: 'res.partner',
                    method: 'search_read',
                    args: [domain, fields],
        ...
        load_server_data: function () {
            ...
            return posmodel_super.load_server_data.apply(this, arguments).then(function () {
                ...
                if(self.user.access_gift_card && self.config.enable_gift_card){
                    // alert("CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC")
                ...
                // alert("KHHHFFFFFFFFFFFFFFFFFFFF")
                rpc.query(params)
...
//	        }
            // console.log(this.employee.barcode);
        ...
        set_cashier: function(employee){
            ...
            // alert(employee + "dddddddddddddddddddddddddddddd");
            // console.log(employee);
            if(employee.user_role == "cashier"){
                // alert("llllllllllllllllllllllllllll")
            ...
            var params = {
                model: 'pos.session',
                method: 'write',
                args: [self.pos_session.id,{'current_cashier_id':employee.id}],
            }
            // alert("CVVVVVVVVVVRRTTTTTTYUUUUUUUUUUUUU")
            rpc.query(params, {async: false}).then(function(result){
                if(employee.lock_terminal){
