...
//            Cashbox line 
	    ...
	    get_product_by_value_and_products: function(value_id, products){
            ...
            for (var i = 0, len = products.length; i < len; i++) {
                if (products[i] && products[i].product_template_attribute_value_ids.indexOf(value_id) != -1){
        ...
        add_templates: function(templates){
            for(var i=0 ; i < templates.length; i++){
                ...
                for (var j = 0; j <templates[i].product_variant_ids.length; j++){
                    ...
                    if(product){
                    	for (var k = 0; k < product.product_template_attribute_value_ids.length; k++){
                            if (attribute_value_ids.indexOf(product.product_template_attribute_value_ids[k])==-1){
                                attribute_value_ids.push(product.product_template_attribute_value_ids[k]);
                            }
                        }
